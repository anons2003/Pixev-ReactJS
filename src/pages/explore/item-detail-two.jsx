...
import bg1 from '../../assets/images/items/item-detail.jpg'
import bg2 from '../../assets/images/items/item-detail-1.jpg'
...
import { activityData, bidsData } from '../../data/data'

import Modal from 'react-bootstrap/Modal';

export default function ItemDetailTwo() {
          ...
          <div className="row mt-5">
              <div className="col py-5 py-sm-0 my-5 my-sm-0">
                  <div className="play-icon">
                      <Link to="#" className="play-btn lightbox" onClick={()=>showModal(0)}>
                          ...
                          <div className="col">
                              ...
                              <div className="row mt-5">
                                  <div className="col-12">
                                      <ul className="nav nav-tabs border-bottom justify-content-center" id="myTab" role="tablist">
                                        ...
                                        <div className="tab-pane fade show active">
                                            ...
                                            <div className="creators creator-primary d-flex align-items-center">
                                                <div className="position-relative">
                                                    <img src={clientImg} className="avatar avatar-md-sm shadow-md rounded-pill" alt=""/>
                                                ...
                                                <div className="ms-3">
                                                    <h6 className="mb-0"><Link to="/creators" className="text-dark name">PandaOne</Link></h6>
                                                </div>
                                            </div>
                                        </div>
                                      )}
